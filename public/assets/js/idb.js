...
//.open() method we use here takes the following two parameters: The name of the IndexedDB database you'd like to create or connect to and 2) The version of the database. By default, we start it at 1. This parameter is used to determine whether the database's structure has changed between connections. 
